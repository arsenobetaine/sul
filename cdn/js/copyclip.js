...
(() => {
    ...
    var Ct = (s, o, n, r) => {
        if (o && typeof o == "object" || typeof o == "function")
            for (let e of ht(o)) !Rt.call(s, e) && e !== n && q(s, e, {
                get: () => o[e],
                enumerable: !(r = _t(o, e)) || r.enumerable
            });
        return s
    };
    var Ut = (s, o, n) => (n = s != null ? gt(It(s)) : {}, Ct(o || !s || !s.__esModule ? q(n, "default", {
        value: s,
        enumerable: !0
    }) : n, s));
    var ct = wt((w, H) => {
        (function(o, n) {
            typeof w == "object" && typeof H == "object" ? H.exports = n() : typeof define == "function" && define.amd ? define([], n) : typeof w == "object" ? w.ClipboardJS = n() : o.ClipboardJS = n()
        })(w, function() {
            return function() {
                var s = {
                        686: function(r, e, t) {
                            ...
                            function v(p) {
                                ...
                                i.style.fontSize = "12pt", i.style.border = "0", i.style.padding = "0", i.style.margin = "0", i.style.position = "absolute", i.style[u ? "right" : "left"] = "-9999px";
                            ...
                            var G = function(u, i) {
                                ...
                                ft = function(u) {
                                    var i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {
                                        ...
                                        l = "";
                                    return typeof u == "string" ? l = G(u, i) : u instanceof HTMLInputElement && !["text", "search", "url", "tel", "password"].includes(u == null ? void 0 : u.type) ? l = G(u.value, i) : (l = x()(u), b("copy")), l
                                },
                                P = ft;

                            function C(p) {
                                return typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? C = function(i) {
                                    return typeof i
                                } : C = function(i) {
                            ...
                            var pt = function() {
                                    ...
                                    if (m !== void 0)
                                        if (m && C(m) === "object" && m.nodeType === 1) {
                                            ...
                                            if (l === "cut" && (m.hasAttribute("readonly") || m.hasAttribute("disabled"))) throw new Error(`Invalid "target" attribute. You can't cut text from elements with "readonly" or "disabled" attributes`)
                                        } else throw new Error('Invalid "target" value, use a valid Element');
                                    if (S) return P(S, {
                                        container: f
                                    });
                                    if (m) return l === "cut" ? E(m) : P(m, {
                                        container: f
                                    })
                                },
                                dt = pt;
                            ...
                            function I(p) {
                                return typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? I = function(i) {
                                    return typeof i
                                } : I = function(i) {
                                    return i && typeof Symbol == "function" && i.constructor === Symbol && i !== Symbol.prototype ? "symbol" : typeof i
                                }, I(p)
                            ...
                            function B(p, u) {
                                return B = Object.setPrototypeOf || function(l, f) {
                            ...
                            function U(p) {
                                return U = Object.setPrototypeOf ? Object.getPrototypeOf : function(i) {
                        ...
                        438: function(r, e, t) {
                            ...
                            function a(T, x, b, A, E) {
                                ...
                                return T.addEventListener(b, v, E), {
                                    destroy: function() {
                            ...
                            function d(T, x, b, A, E) {
                                return typeof T.addEventListener == "function" ? a.apply(null, arguments) : typeof b == "function" ? a.bind(null, document).apply(null, arguments) : (typeof T == "string" && (T = document.querySelectorAll(T)), Array.prototype.map.call(T, function(v) {
                                    return a(v, x, b, A, E)
                                }))
                            }
                        ...
                        370: function(r, e, t) {
                            ...
                            function T(b, A, E) {
                                return Array.prototype.forEach.call(b, function(v) {
                            ...
                            e.prototype = {
                                ...
                                off: function(t, c) {
                                    var a = this.e || (this.e = {}),
                                        ...
                                        y = [];
                                    if (d && c)
                                        for (var T = 0, x = d.length; T < x; T++) d[T].fn !== c && d[T].fn._ !== c && y.push(d[T]);
    ...
    var ut = Ut(ct(), 1),
        at = ({
            ...
            let d = new ut.default(s, {
                    text: () => o || (n ? V(n) ? n.value : n.textContent || "" : s.textContent || "")
                }),
                y = !1;
            return d.on("success", T => {
                T.clearSelection(), !y && (y = !0, s.classList.add(a), r && t && (r.textContent = t), setTimeout(() => {
    ...
    var {
        ...
        let o = j("trigger", {
            ...
            let r = n.getAttribute(Gt),
                ...
                a = nt(n, Ht),
                y = ((A = n.parentElement) == null ? void 0 : A.querySelector(ot("element", "sibling", {
                    operator: "prefixed"
                }))) || j("target", {
                    instanceIndex: a
                }),
